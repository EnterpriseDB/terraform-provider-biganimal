...
// APIClient manages communication with the BigAnimal API v2.5.1
...
type APIClient struct {
	...
	ClusterArchitecturesApi *ClusterArchitecturesApiService

	ClustersApi *ClustersApiService

	EventsApi *EventsApiService

	FreeTrialApi *FreeTrialApiService

	IntegrationsApi *IntegrationsApiService

	JWKSApi *JWKSApiService
