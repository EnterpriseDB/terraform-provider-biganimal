...
// ClusterPgConfigParameter struct for ClusterPgConfigParameter
...
func (o ClusterPgConfigParameter) MarshalJSON() ([]byte, error) {
...
type NullableClusterPgConfigParameter struct {
	value *ClusterPgConfigParameter
	isSet bool
}

func (v NullableClusterPgConfigParameter) Get() *ClusterPgConfigParameter {
	return v.value
}

func (v *NullableClusterPgConfigParameter) Set(val *ClusterPgConfigParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterPgConfigParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterPgConfigParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterPgConfigParameter(val *ClusterPgConfigParameter) *NullableClusterPgConfigParameter {
	return &NullableClusterPgConfigParameter{value: val, isSet: true}
}

func (v NullableClusterPgConfigParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterPgConfigParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
